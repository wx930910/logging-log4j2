...
public class LevelTest {
	...
	public void testSerializeINFO() throws Exception {
		...
		SerializationTestHelper.assertSerializationEquals("target/test-classes/witness/serialization/info.bin",
	...
	public void testDeserializeINFO() throws Exception {
		final Object obj = SerializationTestHelper
				.deserializeStream("target/test-classes/witness/serialization/info.bin");
	...
	/**
	 * Tests that a custom level can be serialized and deserialized and is not
	 * resolved to a stock level.
	 *
	 * @throws Exception if exception during test.
	 */
	@Test
	...
	/**
	 * Custom level to check that custom levels are serializable, but not resolved
	 * to a plain Level.
	 */
	...
	/**
	 * Test that dotted lower I + "nfo" is recognized as INFO even in Turkish
	 * locale.
	 */
	@Test
