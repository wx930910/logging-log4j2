...
public class AbstractDatabaseAppenderTest {
	public static AbstractDatabaseAppender<LocalAbstractDatabaseManager> mockAbstractDatabaseAppender1(
		...
		AbstractDatabaseAppender<LocalAbstractDatabaseManager> mockInstance = Mockito.mock(
				AbstractDatabaseAppender.class,
				Mockito.withSettings()
						.useConstructor(name, filter, null, ignoreExceptions, Property.EMPTY_ARRAY, manager)
