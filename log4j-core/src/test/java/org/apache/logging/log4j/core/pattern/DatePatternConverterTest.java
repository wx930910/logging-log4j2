...
public class DatePatternConverterTest {
	...
	public AbstractLogEvent mockAbstractLogEvent1() {
		long mockFieldVariableSerialVersionUID = 0;
		...
		Mockito.doAnswer((stubInvo) -> {
			...
			result.initFromEpochMilli(mockInstance.getTimeMillis(), 123456);
			return result;
		}).when(mockInstance).getInstant();
		return mockInstance;
	}
	...
	public DatePatternConverterTest(final Boolean threadLocalEnabled) throws Exception {
		// Setting the system property does not work: the Constant field has already
		// been initialized...
	...
	public void testFormatDateStringBuilderIso8601WithPeriodMicroseconds() {
		...
		instant.initFromEpochMilli(1577225134559L,
				// One microsecond
				1000);
	...
	@Test
	public void testFormatLogEventStringBuilderDefaultPattern() throws Exception {
	...
	@Test
	public void testFormatLogEventStringBuilderIso8601() throws Exception {
		final AbstractLogEvent event = mockAbstractLogEvent1();
		final DatePatternConverter converter = DatePatternConverter.newInstance(ISO8601_FORMAT_OPTIONS);
		final StringBuilder sb = new StringBuilder();
		converter.format(event, sb);
	...
	@Test
	public void testFormatLogEventStringBuilderIso8601TimezoneJST() throws Exception {
		final AbstractLogEvent event = mockAbstractLogEvent1();
		...
		// final String expected = "2011-12-30T18:56:35,987"; // in CET (Central Eastern
		// Time: Amsterdam)
		assertEquals(expected, sb.toString());
	}

	@Test
	public void testFormatLogEventStringBuilderIso8601TimezoneOffsetHHCMM() throws Exception {
		final AbstractLogEvent event = mockAbstractLogEvent1();
	...
	@Test
	public void testFormatLogEventStringBuilderIso8601TimezoneOffsetHHMM() throws Exception {
		final AbstractLogEvent event = mockAbstractLogEvent1();
	...
	@Test
	public void testFormatLogEventStringBuilderIso8601TimezoneUTC() throws Exception {
		final AbstractLogEvent event = mockAbstractLogEvent1();
	...
	@Test
	public void testFormatLogEventStringBuilderIso8601TimezoneZ() throws Exception {
		final AbstractLogEvent event = mockAbstractLogEvent1();
	...
	@Test
	public void testInvalidLongPatternIgnoresExcessiveDigits() throws Exception {
	...
	@Test
	public void testPredefinedFormatWithAnyValidNanoPrecision() throws Exception {
		final StringBuilder preciseBuilder = new StringBuilder();
		final StringBuilder milliBuilder = new StringBuilder();
		final AbstractLogEvent event = mockAbstractLogEvent1();
