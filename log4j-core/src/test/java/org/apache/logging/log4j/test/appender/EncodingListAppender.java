...
public class EncodingListAppender extends ListAppender {
	...
	public ByteBufferDestination mockByteBufferDestination1() {
		ByteBuffer mockFieldVariableByteBuffer = ByteBuffer.wrap(new byte[4096]);
	...
	public synchronized void append(final LogEvent event) {
		...
		if (layout == null) {
			...
			final ByteBufferDestination content = mockByteBufferDestination1();
